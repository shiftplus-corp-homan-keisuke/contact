...
export class FileStorageController {
  ...
  async getStorageUsage(): Promise<BaseResponseDto<StorageUsageDto>> {
    ...
    return new BaseResponseDto(usage as StorageUsageDto);
  }
  ...
  async performCleanup(): Promise<BaseResponseDto<FileCleanupResultDto>> {
    ...
    return new BaseResponseDto(result as FileCleanupResultDto, true, `${result.cleanedFileCount}個のファイルをクリーンアップしました`);
  }
  ...
  async archiveFiles(): Promise<BaseResponseDto<FileArchiveResultDto>> {
    ...
    return new BaseResponseDto(result as FileArchiveResultDto, true, `${result.archivedFileCount}個のファイルをアーカイブしました`);
  }
  ...
  async createBackup(): Promise<BaseResponseDto<BackupResultDto>> {
    ...
    return new BaseResponseDto(result as BackupResultDto, true, `${result.fileCount}個のファイルをバックアップしました`);
  }
  ...
  async generateStorageReport(): Promise<BaseResponseDto<StorageReportDto>> {
    ...
    return new BaseResponseDto(report as StorageReportDto);
  }
  ...
  async optimizeStorage(): Promise<BaseResponseDto<{
    ...
    return new BaseResponseDto({
      ...
      totalFreedSize
    }, true, `ストレージ最適化完了: ${this.formatFileSize(totalFreedSize)}を解放しました`);
  }
